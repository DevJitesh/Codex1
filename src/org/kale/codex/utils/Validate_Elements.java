...
import org.kale.codex.TestDataReaders.ExcelFileReader;
import org.kale.codex.sdk.Variables_Declaration;
...
public class Validate_Elements 
{
	...
	public void ElementCheck11(String SC_ID, String Description, int Srno, String Element, String Id,
			String ExpectedResult, String ActualResultTrue, String ActualResultFalse,String Status,int r,String filename,
			WebDriver driver,String StartTime) throws Exception 
	{
		...
		String EndTime,Duration,ScreenShotPath;
		...
		SimpleDateFormat format = new SimpleDateFormat("HH:mm:ss");
		 if(Element == "Match")
	        {	        	 
	     	...
	     	rw.WriteToExcel(SC_ID, Description, Srno, ExpectedResult, vd.ActualResult, "",vd.status, StartTime,
		 ...
		 if(Element == "Match")
	        {
			 if(StartTime_fromExcel.equals("EndTime"))
	           ...
	           rw.WriteToExcel(SC_ID, Description, Srno, ExpectedResult,ActualResultTrue, " ", "Pass", StartTime,
	...
	public void IsNumeric(String SC_ID, String Description, int Srno, String Element, String Id, int length,
			String ExpectedResult, String ActualResultTrue, String ActualResultFalse, int r, String ExcelSavePath,
			WebDriver driver,String StartTime)
			throws Exception {
